...
import com.vacart.ble.data.DownloadingQuestions
import com.vacart.ble.data.Name
import com.vacart.ble.data.Player
import com.vacart.ble.data.Players
import com.vacart.ble.data.Question
import com.vacart.ble.data.Questions
import com.vacart.ble.data.Results
import com.vacart.ble.data.Round
import com.vacart.ble.data.ServerViewState
import com.vacart.ble.data.WaitingForPlayers
...
ServerViewModel @Inject constructor(
                            ...
                            .onEach { connectionState ->
                                ...
                                when (connectionState) {
                                    ConnectionState.Ready -> {
                                        ...
                                        println("One client connected - $this")
                                    }
